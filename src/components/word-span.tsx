...
interface WordSpanProps {
    ...
    index: number;
    isSelected: boolean;
    onClick: (index: number, event?: React.MouseEvent | React.KeyboardEvent) => void;
}

export const WordSpan = forwardRef<HTMLSpanElement, WordSpanProps>(
    ({ word, index, isSelected, onClick, ...props }, ref) => {
        return (
            <span
                ref={ref}
                role="button"
